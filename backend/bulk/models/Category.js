...
const categorySchema = new mongoose.Schema(
  {
    ...
    calculationMethod: {
      type: String,
      enum: ['DIRECT_PERCENTAGE', 'BEST_5'],
      default: 'DIRECT_PERCENTAGE',
    },
    ...
    guestMode: {
      type: String,
      enum: ['FIXED_OR_AVAILABLE', 'ROTATIONAL', 'MANUAL'],
      default: 'FIXED_OR_AVAILABLE',
    },

    teamMode: {
      type: String,
      enum: ['ROTATIONAL', 'FIXED', 'MANUAL'],
      default: 'ROTATIONAL',
    },
