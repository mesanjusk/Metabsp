...
import { requireExtensionAuth, ExtensionUnauthorizedError } from "@/lib/video/core/browser/extension-auth";
import { extensionTaskUpdateSchema } from "@/lib/video/modules/browser-automation/schema";
import { updateExtensionTask } from "@/lib/video/modules/browser-automation/extension-service";
import { wakeImageJobForRun } from "@/lib/video/core/production/flow-image-wake";
