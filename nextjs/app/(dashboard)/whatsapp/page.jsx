...
const WorkflowManagementPanel  = lazy(() => import('@/lib/ui/whatsappCloud/WorkflowManagementPanel'));
const CRMPanel            = lazy(() => import('@/lib/ui/whatsappCloud/CRMPanel'));
...
export default function WhatsAppCloudDashboard() {
  ...
  // Pages/Layout.jsx passed this down through react-router's outlet context.
  // The App Router has no equivalent, and the handler was three lines, so it
  // lives here instead of inventing a context to carry it.
  ...
  return (
    <Box sx={{ height: '100dvh', overflow: 'hidden', display: 'grid', gridTemplateColumns: { lg: '72px minmax(0, 1fr)' }, gridTemplateRows: '1fr', bgcolor: { xs: '#e9edef', lg: '#111b21' } }}>
      ...
      >
        ...
        <Divider />
        <MenuItem onClick={() => { setMobileMenuAnchorEl(null); handleLogout(); }}>
          <ListItemIcon><LogoutRoundedIcon fontSize="small" /></ListItemIcon>
