...
export const SERVICES = [
  ...
  { slug: 'google-business', label: 'Google Business Profile', shortLabel: 'Google', description: 'Business profile, reviews, posts and local presence. Provider connection required.', href: '/services/google-business', icon: StorefrontRoundedIcon, status: 'planned', tier: 'basic' },
