...
import { instagramReplyTemplate } from "@/lib/video/core/prompt-engine/templates/instagram-reply";
import type { PromptTemplateDefinition } from "@/lib/video/core/prompt-engine/types";
