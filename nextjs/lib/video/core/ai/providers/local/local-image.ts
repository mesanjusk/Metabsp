import type {
  ...
  SceneImageInput,
  ThumbnailInput,
} from "@/lib/video/core/ai/types";
import { getFeatureFlags } from "@/lib/video/core/config/flags";
import { renderTemplate } from "@/lib/video/core/prompt-engine/engine";
import { backgroundTemplate, characterTemplate, sceneImageTemplate, thumbnailTemplate } from "@/lib/video/core/prompt-engine/templates";
