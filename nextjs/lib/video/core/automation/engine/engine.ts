import { executeBrowserAction, BROWSER_NODE_TYPES } from "@/lib/video/core/browser";
import { AutomationError, type AgentAction, type WorkflowNode } from "@/lib/video/core/browser/shared";
