...
vi.mock("@/lib/video/core/ai/provider-health", () => ({
...
vi.mock("@/lib/video/core/ai/registry", () => ({
...
vi.mock("@/lib/video/modules/accounts/service", () => ({
...
vi.mock("@/lib/video/core/browser/extension-presence", () => ({
