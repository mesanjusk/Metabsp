...
import { Scene, type SceneDoc } from "@/lib/video/modules/scenes/models/Scene";
...
import { getVideoProvider } from "@/lib/video/core/ai/registry";
...
import { advanceScene } from "@/lib/video/core/queue/orchestrator";
import type { VideoGenerationResult } from "@/lib/video/core/ai/types";
import { checkVideoDuration } from "@/lib/video/core/quality/checks";
...
import { getFeatureFlags } from "@/lib/video/core/config/flags";
import { isWorkerRunning } from "@/lib/video/core/queue/worker-presence";
