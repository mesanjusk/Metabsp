...
import { getStoryProvider } from "@/lib/video/core/ai/registry";
import { createScenesFromStory } from "@/lib/video/modules/scenes/service";
...
import { autoCastFromStory } from "@/lib/video/core/production/auto-cast";
