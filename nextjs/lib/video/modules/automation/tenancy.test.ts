 ...
 */
const MODULES_DIR = path.join(path.dirname(fileURLToPath(import.meta.url)), "..");
const MODEL_DIRS = ["automation/models", "production-plans/models", "browser-automation/models"].map((dir) =>
  path.join(MODULES_DIR, dir),
);
